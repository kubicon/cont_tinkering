...
class VTraceOutput:
    ...
    rho: chex.Array  # truncated importance weights `min(rho_bar, pi / mu)`
...
def vtrace(
    ...
    pg_advantage = own * (segment_reward + gamma * next_vs - values)
    return VTraceOutput(vs=vs * own, pg_advantage=pg_advantage, rho=rho * own)
